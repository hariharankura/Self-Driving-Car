...
static const uint16_t FRONT_BACK_THRESHOLD_OBSTACLE_VERY_NEAR = FRONT_BACK_THRESHOLD_VERY_NEAR - 1;
static const uint16_t FRONT_BACK_THRESHOLD_OBSTACLE_NEAR = FRONT_BACK_THRESHOLD_NEAR - 1;
static const uint16_t FRONT_BACK_THRESHOLD_OBSTACLE_VERY_FAR = FRONT_BACK_THRESHOLD_NEAR + 1;

void setUp() {
  test_sensor_data.SENSOR_USONARS_front = FRONT_BACK_THRESHOLD_OBSTACLE_VERY_FAR;
  test_sensor_data.SENSOR_USONARS_back = FRONT_BACK_THRESHOLD_OBSTACLE_VERY_FAR;
...
void test_obstacle_avoidance__process_ultrasonic_sensors_data(void) {
  ...
  TEST_ASSERT_EQUAL_UINT16(FRONT_BACK_THRESHOLD_OBSTACLE_VERY_FAR, sensor_data.SENSOR_USONARS_front);
  TEST_ASSERT_EQUAL_UINT16(FRONT_BACK_THRESHOLD_OBSTACLE_VERY_FAR, sensor_data.SENSOR_USONARS_back);
...
void test_obstacle_avoidance__at_front_near_is_fill_sensor_data(void) {
  test_sensor_data.SENSOR_USONARS_front = FRONT_BACK_THRESHOLD_OBSTACLE_NEAR;
  obstacle_avoidance__process_ultrasonic_sensors_data(test_sensor_data);
...
void test_obstacle_avoidance__at_front_VERY_near_is_fill_sensor_data(void) {
  test_sensor_data.SENSOR_USONARS_front = FRONT_BACK_THRESHOLD_OBSTACLE_VERY_NEAR;
  obstacle_avoidance__process_ultrasonic_sensors_data(test_sensor_data);
...
void test_obstacle_avoidance__at_back_near_is_fill_sensor_data(void) {
  test_sensor_data.SENSOR_USONARS_back = FRONT_BACK_THRESHOLD_OBSTACLE_NEAR;
  obstacle_avoidance__process_ultrasonic_sensors_data(test_sensor_data);
...
void test_obstacle_avoidance__at_back_VERY_near_is_fill_sensor_data(void) {
  test_sensor_data.SENSOR_USONARS_back = FRONT_BACK_THRESHOLD_OBSTACLE_VERY_NEAR;
  obstacle_avoidance__process_ultrasonic_sensors_data(test_sensor_data);
...
void test_obstacle_avoidance__in_near_front_left_get_direction(void) {
  ...
  obstacle_avoidance__get_direction(&test_motor_info);
  TEST_ASSERT_EQUAL(DRIVER_STEER_direction_SOFT_LEFT, test_motor_info.DRIVER_STEER_direction);
  TEST_ASSERT_EQUAL_INT16(DRIVER_STEER_move_FORWARD_at_LOW_SPEED, test_motor_info.DRIVER_STEER_move_speed);
}
...
void test_obstacle_avoidance__in_no_obstacle_back_get_direction(void) {
  test_sensor_data.SENSOR_USONARS_front = FRONT_BACK_THRESHOLD_OBSTACLE_VERY_NEAR;
  obstacle_avoidance__process_ultrasonic_sensors_data(test_sensor_data);
  obstacle_avoidance__get_motor_direction(&test_motor_info);
  obstacle_avoidance__get_steer_direction(&test_motor_info);
